...
lector_1 = Lecturer('Shrek', 'Green')
lector_2 = Lecturer('Kurt', 'Cobain')
#
...
best_student.rate_hw(lector_2, ['Python'], [10])
#
...
#
reviewer.rate_hw(best_student, ['Python', 'Git'], [10, 10])
...
best_student1 = Student('Ruoy', 'Eman')
best_student2 = Student('Donkey', 'Smit')
...
reviewer.rate_hw(best_student2, ['Python', 'Git'], [10, 9])
print(best_student1)
print(best_student2)
print(best_student1 > best_student2)
print()

mentor1 = Mentor(name='Some', surname='Buddy')
mentor2 = Mentor(name='Somebody', surname='OnceToldMe')

reviewer1 = Reviewer(name='Fiona', surname='Green', courses_attached=['Python', 'Git'])
reviewer2 = Reviewer(name='Jimi', surname='Hendrix', courses_attached=['Python', 'Git'])
...
def mean_grade_per_course(names, course):
    ...
    for firstname in names:
        ...
        reviewerN = Reviewer(name='Jimi', surname='Hendrix', courses_attached=course)
...
def mean_grade_per_course_lectors(names, course):
    ...
    for firstname in names:
        ...
        student = Student(name='Donkey', surname='Smit')
...
name = ['Николай Пупкин', 'Леся Капитанова', 'Александр Звонарь']
course = ['Git']
